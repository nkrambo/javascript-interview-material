...
import { getIntersectionNode, getIntersectionNodePointers } from '../intersection_of_two_linked_lists';
...
describe('getIntersectionNodePointers', () => {
  test('should return the intersecting node if two linked lists intersect', () => {
    /*
    *     3 → 1 → 5 → 9
    *                   ↘
    ...
    */
    ...
    // return intersection
    const intersection = getIntersectionNodePointers(listA, listB);
    expect(intersection.val).toBe(7);
    expect(intersection.next.val).toBe(2);
  });
  ...
  test('should return null if there is no intersection', () => {
    ...
    */
    ...
    expect(getIntersectionNodePointers(listA, listB)).toBeNull();
  });
});
