...
* Space: O(1)
*
* @param {array} grid of 1s and 0s representing friend relationships, a matrix
* @return {number} returns total number of friend circles
*/

function friendCircles(grid) {
