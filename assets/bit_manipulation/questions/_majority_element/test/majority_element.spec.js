...
//
// describe('majorityBtest()', () => {
//   test('should return the majority element from an array of integers', () => {
//     expect(majorityBtest([1, 2, 3, 4, 5, 5, 5, 5, 5, 5])).to.equal(5);
//     expect(majorityBtest([1, 2, 1, 4, 1])).to.equal(1);
//   });
// });
//
