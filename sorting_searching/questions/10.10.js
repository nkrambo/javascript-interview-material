...
// implement the method track(x), which is called when each number is generated, and
// the method getRankOfNumber(x), which returns the number of values less than or
